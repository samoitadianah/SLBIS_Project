...
$query=mysqli_query($con,"select * from location where location_id='$location'")or die(mysqli_error($con));
        ...
        <nav class="navbar navbar-static-top">
          <div class="container">
            <div class="navbar-header" style="padding-left:20px">
              <a href="home.php" class="navbar-brand"><b><i class="glyphicon glyphicon-home"></i> <?php echo $location_name;?> </b></a>
                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php 
                      $query=mysqli_query($con,"select COUNT(*) as count from product where prod_qty<=reorder and location_id='$location'")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>	
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      <li class="header">You have <?php echo$row['count'];?> Clothes that needs reorder</li>
                      <li>
                        <!-- Inner Menu: contains the notifications -->
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select prod_name from product where prod_qty<=reorder and location_id='$location'")or die(mysqli_error());
                    ...
                    <ul class="dropdown-menu">
                      <li>
                        ...
                        <ul class="menu">
						  ...
						  <li><!-- start notification -->
                            <a href="product.php">
                              <i class="glyphicon glyphicon-cutlery text-green"></i> Clothes
                            </a>
                          </li><!-- end notification -->
                     ...
                     <li>
					    ...
					    <li><!-- start notification -->
                         <!-- <a href="receivables.php">
						  ...
						  <li><!-- start notification -->
                         <a href="income.php">
                              <i class="glyphicon glyphicon-th-list text-redr"></i>Location Income
                            </a>
                          </li><!-- end notification -->
                          <li><!-- start notification -->
