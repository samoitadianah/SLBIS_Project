          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu" style="display: none;">
				<li><a href="blotter.php"><i class="glyphicon glyphicon-plus"></i>Add New Cloth</a></li>	
				<li><a href="blotter_list.php"><i class="glyphicon glyphicon-th-list"></i>Clothes List</a></li>	
              </ul>
            </li>
            <li class="treeview">
              <a href="">
