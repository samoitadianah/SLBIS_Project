                ...
                <ul class="nav navbar-nav">
                  ...
                  <li class="dropdown notifications-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                      ...
                      <?php 
                      $query=mysqli_query($con,"select COUNT(*) as count from prod_location natural join product where prod_qty<=reorder and location_id='$location'")or die(mysqli_error());
                			$row=mysqli_fetch_array($query);
                			echo $row['count'];
                			?>	
                      </span>
                    ...
                    <ul class="dropdown-menu">
                      ...
                      <li>
                        ...
                        <ul class="menu">
                        <?php
                        $queryprod=mysqli_query($con,"select prod_name from product natural join prod_location where prod_qty<=reorder and location_id='$location'")or die(mysqli_error());
