...
$query=mysqli_query($con,"select * from user natural join location where username='$user' and password='$pass' and location_id='$location' and status='active'")or die(mysqli_error($con));
    ...
    $query1=mysqli_query($con,"select * from payment natural join customer where location_id='$location' and status<>'paid'")or die(mysqli_error($con));
