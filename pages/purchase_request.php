...
?>			
                  ...
                  <h6><?php echo $row['location_address'];?></h6>
...
<?php
		$query=mysqli_query($con,"select * from purchase_request natural join product natural join supplier where location_id='$location' and purchase_status='pending' and date(request_date)>='$start' and date(request_date)<='$end' ")or die(mysqli_error($con));
