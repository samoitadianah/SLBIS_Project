...
<?php
		...
		$query=mysqli_query($con,"select * from purchase_request natural join product natural join supplier where location_id='$location' order by request_date")or die(mysqli_error());
