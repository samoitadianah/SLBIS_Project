...
?>          
           <table class="table">
                    <thead>
                      <tr>
                        <th colspan="3"><h5><b><?php echo $rowb['location_name'];?></b></h5></th>
                        <th><b><u>SALES INVOICE</u></b></th>
                      </tr>
                      <tr>
                        <th colspan="3"><h6><?php echo $rowb['location_address'];?></h6></th>
                        <th><span style="font-size: 16px;color: red">No. <?php echo $row1['or_no'];?></span></th>
                      </tr>
                      <tr>
                        <th colspan="3"><h6>Contact: <?php echo $rowb['location_contact'];?></h6></th>
                        <th></th>
                      </tr>
