...
$location=$_SESSION['location'];
    $query=mysqli_query($con,"select * from location where location_id='$location'")or die(mysqli_error());
  
        $row=mysqli_fetch_array($query);
        
?>      
                  <h5><b><?php echo $row['location_name'];?></b> </h5>  
                  <h6>Address: <?php echo $row['location_address'];?></h6>
                  <h6>Contact: <?php echo $row['location_contact'];?></h6>
...
<?php
		$location=$_SESSION['location'];
		$query=mysqli_query($con,"select * from customer natural join sales natural join sales_details natural join term natural join product where balance<>0 and location_id='$location' and status<>'paid' order by cust_last desc")or die(mysqli_error());
		...
		<?php }?>			  
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th><h4><b><?php 
                        $querytotal=mysqli_query($con,"select SUM(balance) as total from customer where location_id='$location'")or die(mysqli_error());
