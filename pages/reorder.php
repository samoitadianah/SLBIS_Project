...
<html>
  <head>
    ...
    <title>Clothes Reorder | <?php include('../dist/includes/title.php');?></title>
...
<?php
		...
		$query=mysqli_query($con,"select * from product natural join supplier natural join category where location_id='$location' and prod_qty<=reorder order by prod_name")or die(mysqli_error());
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Cloth Code</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['serial'];?>" readonly>  
				...
				<div class="form-group">
					<label class="control-label col-lg-3" for="name">Cloth Name</label>
